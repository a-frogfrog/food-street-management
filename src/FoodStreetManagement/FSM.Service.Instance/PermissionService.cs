    ...
    public class PermissionService : ResponseHelper, IPermissionService
    {
        ...
        public async Task<ApiResponse> CreatePermission(CreatePermissionRequestDto dto)
        {
            ...
            Permission permission = new()
            {
                ...
                Status = _globalStatusHelper.PermissionActive,
                PermName = dto.Name,
                Type = dto.Type,
                Url = dto.Url,
        ...
        public async Task<ApiResponse> GetPermissionList()
        {
            ...
            List<GetPermissionResponseDto> data = new List<GetPermissionResponseDto>();
        ...
        private List<GetPermissionResponseDto> GetPermissionChildren(List<Permission> query, string permId)
        {
        ...
        public async Task<ApiResponse> GetUserPermissionMenuList(string userId)
        {
            ...
            var permissions = await _permissionDependencies.Permission
                ...
                && q.Status == _globalStatusHelper.PermissionActive)
                .ToListAsync();

            var root = permissions.Where(s => s.ParentId == null || s.ParentId == "").ToList();

            List<GetPermissionMenuResponseDto> data = new List<GetPermissionMenuResponseDto>();
        ...
        public async Task<ApiResponse> GrantPermission(GrantPermissionRequestDto dto)
        {
            ...
            List<Userpermission> data = new List<Userpermission>();
        ...
        private List<GetPermissionMenuResponseDto> GetPermissionMenuChildren(List<Permission> permissions, string permId)
        {
        ...
        //private List<TResult> GetTreeChildren<TResult, TSource>(
        //    List<TSource> data,
        //    Func<TSource, string> getId,
        //    Func<TSource, List<TResult>, TResult> converter)
        //{  

        //    return data.Where(x => true)
        //        .Select(x => converter(
        //            x,
        //            GetTreeChildren(data,  getId, converter)))
        //        .ToList();
